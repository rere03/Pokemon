...
<!--content-->
	<div class="container">
			<div class="games">
			<h2> pidgey</h2>
			<p>Poppo memiliki kemampuan mengenal arah yang sangat tajam. Ia mampu pulang ke sarangnya dengan pasti, sejauh apapun ia dipindahkan dari lingkungan yang dikenalnya</p>
			<p>Tipe      : Terbang</p>
			<p>Kelemahan : Listrik, Es, Karang</p>
			<p>Kemampuan : Mata Tajam, Sempoyongan</p>
			<button><a href="<?=base_url()?>index.php/Home/tambah">Tangkap</button>
			<div class="wrap">	
			<div class="main">
				<ul id="og-grid" class="og-grid">
					<li>
						<a href="<?=base_url()?>index.php/Home/pidgey" data-largesrc="<?=base_url()?>images/3aa.png">
