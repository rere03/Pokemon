	...
	<div class="container">
			...
			<div class="main">
				<ul id="og-grid" class="og-grid">
					...
					<li>
						<a href="<?=base_url()?>index.php/Home/ulat" data-largesrc="<?=base_url()?>images/2aa.png" data-title="Angry Birds" data-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque malesuada purus a convallis dictum. Phasellus sodales varius diam, non sagittis lectus. Morbi id magna ultricies ipsum condimentum scelerisque vel quis felis.. Donec et purus nec leo interdum sodales nec sit amet magna. Ut nec suscipit purus, quis viverra urna.">
							<img class="img-responsive" src="<?=base_url()?>images/2aa.png" alt="img02"/>
						</a>
					</li>
					<li>
						<a href="<?=base_url()?>index.php/Home/pidgey" data-largesrc="<?=base_url()?>images/3aa.png" data-title="Bike Games"  data-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque malesuada purus a convallis dictum. Phasellus sodales varius diam, non sagittis lectus. Morbi id magna ultricies ipsum condimentum scelerisque vel quis felis.. Donec et purus nec leo interdum sodales nec sit amet magna. Ut nec suscipit purus, quis viverra urna.">
							<img class="img-responsive" src="<?=base_url()?>images/3aa.png" alt="img03"/>
						</a>
					</li>
