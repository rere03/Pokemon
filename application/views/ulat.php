...
<!--content-->
	<div class="container">
			<div class="games">
			<h2> Ulat </h2>
			<p>Caterpie mengeluarkan bau tidak enak dari antena di kepalanya untuk mengusir musuh dan melindungi dirinya</p>
			<p>Tipe      : Serangga</p>
			<p>Kelemahan : Api, Terbang, Karang</p>
			<p>Kemampuan : Sisik Serangga</p>
			<button><a href="<?=base_url()?>index.php/Home/tambah">Tangkap</button>
			<div class="wrap">	
			<div class="main">
				<ul id="og-grid" class="og-grid">
					<li>
						<a href="<?=base_url()?>index.php/Home/ulat" data-largesrc="<?=base_url()?>images/2aa.png">
